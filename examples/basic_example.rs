...
mod modules;
use rcli_loader::{drawer_helper::{Position, RedGreenScheme}, loading_drawer::{erase_screen, get_loading_drawer, hide_cursor}, loading_element::LoadingElement};
...
async fn main() {
    ...
    let mut drawer = get_loading_drawer();
